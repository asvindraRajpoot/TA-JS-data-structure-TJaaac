...
let desObj={got.houses[0].name : got.houses[0].people.length};
// desObj.got.houses[0].name=got.houses[0].people.length;
// desObj=got.houses[0].people.length;
// desObj=got.houses[1].name;
// desObj=got.houses[1].people.length;
console.log(desObj);
